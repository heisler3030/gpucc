...
ActiveRecord::Schema.define(:version => 20140101061500) do
  ...
  create_table "challengeassignments", :force => true do |t|
    t.integer  "user_id"
    t.integer  "challenge_id"
    t.datetime "joindate"
    t.datetime "completeddate"
    t.datetime "disqualifydate"
  ...
  create_table "completedsets", :force => true do |t|
    t.integer  "user_id"
  ...
  create_table "completedworkouts", :force => true do |t|
    t.integer  "user_id"
    t.datetime "completetime"
